...
class CommentController extends ActiveController
{
    ...
    public function actionGetusercomment()
    {
        ...
        $result = \Yii::$app->db->createCommand("select * from test_comment LEFT JOIN test_user on comment.user_id = test_user.openid where post_id = $postID order by created_at desc")->queryAll();
        return $result;
    }
